...
// 		cy.window().its('mrinimitable').then(mrinimitable => {
// 			mrinimitable.call("mrinimitable.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/mrinimitable.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/mrinimitable.model.utils.user_settings.save')
