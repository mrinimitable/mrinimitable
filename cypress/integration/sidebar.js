...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("mrinimitable")
			.then((mrinimitable) => {
				return mrinimitable.call("mrinimitable.tests.ui_test_helpers.create_doctype_for_attachment");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("mrinimitable.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("mrinimitable.tests.ui_test_helpers.create_todo_with_attachment_limit", {
