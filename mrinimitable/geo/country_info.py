...
def get_country_info(country=None):
	data = get_all()
	data = mrinimitable._dict(data.get(country, {}))
...
from mrinimitable.deprecation_dumpster import get_translated_dict
...
def get_translated_countries():
	...
	translated_dict = {}
	locale = Locale.parse(mrinimitable.local.lang, sep="-")
