...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from mrinimitable.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = mrinimitable.get_meta(self.document_type, cached=False).fields
