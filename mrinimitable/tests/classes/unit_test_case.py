...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for Mrinimitable tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to Mrinimitable framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = mrinimitable.get_module(cls.__module__)
		# Test Environment
		mrinimitable.set_user("Administrator")
		# Test Environment (cleanup)
		cls.addClassCleanup(mrinimitable.set_user, "Administrator")
...
def _get_doctype_from_module(cls):
	...
	path = mrinimitable.get_pymodule_path(cls.__module__)
	try:
