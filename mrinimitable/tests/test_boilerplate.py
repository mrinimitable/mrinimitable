...
import mrinimitable
from mrinimitable.modules.patch_handler import get_all_patches, parse_as_configfile
from mrinimitable.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = mrinimitable._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.shashi_path = mrinimitable.utils.get_shashi_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(mrinimitable.get_app_path("mrinimitable", "patches.txt")))
		...
		expected_patch = "mrinimitable.core.doctype.user.patches.delete_all_users"
