...
from mrinimitable.utils import fmt_money


class TestFmtMoney(IntegrationTestCase):
	def test_standard(self):
		mrinimitable.db.set_default("number_format", "#,###.##")
	...
	def test_currency_precision(self):
		mrinimitable.db.set_default("currency_precision", "4")
		mrinimitable.db.set_default("number_format", "#,###.##")
		self.assertEqual(fmt_money(100), "100.00")
		self.assertEqual(fmt_money(1000), "1,000.00")
		self.assertEqual(fmt_money(10000), "10,000.00")
		...
		mrinimitable.db.set_default("currency_precision", "")
	...
	def test_fmt_with_symbol_pos(self):
		mrinimitable.db.set_value("Currency", "JPY", "symbol_on_right", 1)
