...
def create_test_blog_post():
	test_blog_doc = mrinimitable.get_doc(
		{
			"doctype": "DocType",
			"name": "Test Blog Post",
...
def create_test_blog_records():
	...
	for r in test_blog_records:
		mrinimitable.get_doc(r).insert(ignore_if_duplicate=True, ignore_links=True)
...
def setup_for_tests():
	...
	mrinimitable.delete_doc_if_exists("DocType", "Test Blog Post")
	mrinimitable.delete_doc_if_exists("DocType", "Test Blog Category")
	mrinimitable.delete_doc_if_exists("DocType", "Test Blogger")
