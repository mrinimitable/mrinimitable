...
mrinimitable.provide("mrinimitable.utils.logtypes");

mrinimitable.utils.logtypes.show_log_retention_message = (doctype) => {
	if (!mrinimitable.model.can_write("Log Settings")) {
		return;
	}
