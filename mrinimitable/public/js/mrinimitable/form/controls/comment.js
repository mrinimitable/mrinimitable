...
mrinimitable.ui.form.ControlComment = class ControlComment extends mrinimitable.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${mrinimitable.avatar(mrinimitable.session.user, "avatar-medium")}
					<div class="mrinimitable-control col"></div>
				</div>
		...
		`)
			: $('<div class="mrinimitable-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to mrinimitable-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".mrinimitable-control")
