mrinimitable.ui.form.ControlSignature = class ControlSignature extends mrinimitable.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		mrinimitable.require("/assets/mrinimitable/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${mrinimitable.utils.icon("restriction", "md")}</i>
