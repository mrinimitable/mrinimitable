mrinimitable.ui.form.ControlPassword = class ControlPassword extends mrinimitable.ui.form.ControlData {
	...
	make_input() {
		...
		this.toggle_password = $(`
			<div class="toggle-password hidden">
				${mrinimitable.utils.icon("unhide", "sm")}
			</div>
		`).insertAfter(this.$input);
		...
		this.toggle_password.on("click", () => {
			if (this.$input.attr("type") === "password") {
				...
				this.toggle_password.html(mrinimitable.utils.icon("hide", "sm"));
			} else {
				this.$input.attr("type", "password");
				this.toggle_password.html(mrinimitable.utils.icon("unhide", "sm"));
			}
		});
