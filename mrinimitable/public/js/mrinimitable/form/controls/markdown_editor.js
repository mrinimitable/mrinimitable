mrinimitable.ui.form.ControlMarkdownEditor = class ControlMarkdownEditor extends (
	mrinimitable.ui.form.ControlCode
) {
	...
	update_preview() {
		...
		this.markdown_preview.html(mrinimitable.markdown(value));
	}
