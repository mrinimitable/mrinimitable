...
mrinimitable.ui.form.ControlAutocomplete = class ControlAutoComplete extends mrinimitable.ui.form.ControlData {
	...
	parse_options(options) {
		if (typeof options === "string" && options[0] === "[") {
			options = mrinimitable.utils.parse_json(options);
		}
