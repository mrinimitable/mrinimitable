...
export default class Widget {
	...
	customize(options) {
		...
		options.allow_sorting &&
			mrinimitable.utils.add_custom_button(
				mrinimitable.utils.icon("es-line-drag", "xs"),
				null,
				"drag-handle",
				__("Drag"),
				null,
		...
		options.allow_edit &&
			mrinimitable.utils.add_custom_button(
				mrinimitable.utils.icon("es-line-edit-alt", "xs"),
				() => this.edit(),
				"edit-button",
				__("Edit"),
				null,
	...
	set_title(max_chars) {
		...
		let title = max_chars ? mrinimitable.ellipsis(base, max_chars) : base;
