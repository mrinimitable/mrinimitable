...
mrinimitable.provide("mrinimitable.widget");

mrinimitable.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
mrinimitable.widget.make_widget = (opts) => {
	const widget_class = mrinimitable.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = mrinimitable.widget.make_widget({
			...widget,
...
mrinimitable.widget.WidgetGroup = WidgetGroup;
mrinimitable.widget.SingleWidgetGroup = SingleWidgetGroup;
