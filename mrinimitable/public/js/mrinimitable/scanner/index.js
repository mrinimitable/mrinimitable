...
mrinimitable.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = mrinimitable.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return mrinimitable.require("/assets/mrinimitable/node_modules/html5-qrcode/html5-qrcode.min.js");
	}
};
