mrinimitable.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return mrinimitable.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return mrinimitable
			.call({
				method: "mrinimitable.translate.update_translations_for_source",
