...
class PrintFormatBuilder {
	constructor({ wrapper, page, print_format }) {
		...
		this.page.add_menu_item(__("Edit Print Format"), () => {
			mrinimitable.set_route("Form", "Print Format", this.print_format);
		});
		this.page.add_menu_item(__("Change Print Format"), () => {
			mrinimitable.set_route("print-format-builder-beta");
		});
...
mrinimitable.ui.PrintFormatBuilder = PrintFormatBuilder;
