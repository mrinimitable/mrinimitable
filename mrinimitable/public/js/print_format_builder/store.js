...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			mrinimitable.model.clear_doc("Print Format", print_format_name);
			mrinimitable.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = mrinimitable.get_doc("Print Format", print_format_name);
				mrinimitable.model.with_doctype(_print_format.doc_type, () => {
					meta.value = mrinimitable.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return mrinimitable.db.get_doc("Letter Head", _letterhead).then((doc) => {
