...
import mrinimitable
from mrinimitable.utils import strip
...
def get_context(context):
	should_cache = not_modified_recently(mrinimitable.get_website_settings("modified"))

	website_script = mrinimitable.get_cached_doc("Website Script")
...
def get_setting(field_name):
	...
	website_settings = mrinimitable.get_website_settings(field_name)
	conf = mrinimitable.conf.get(field_name)
