...
def get_context(context):
	if not is_system_user():
		mrinimitable.throw(_("You need to be a system user to access this page."), mrinimitable.PermissionError)
...
def get_js_deps(app: str) -> list[dict]:
	package_json = Path(mrinimitable.get_app_path(app, "..", "package.json"))
	...
	node_modules_path = Path(mrinimitable.get_app_path(app, "..", "node_modules"))
...
def get_pyproject_info(app: str) -> dict:
	pyproject_toml = Path(mrinimitable.get_app_path(app, "..", "pyproject.toml"))
