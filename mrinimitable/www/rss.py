...
import mrinimitable
from mrinimitable.utils import cstr, escape_html, get_request_site_address, now
...
def get_context(context):
	...
	blog_list = mrinimitable.get_all(
		"Blog Post",
	...
	blog_settings = mrinimitable.get_doc("Blog Settings", "Blog Settings")
