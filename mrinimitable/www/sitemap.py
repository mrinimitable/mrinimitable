...
from mrinimitable.utils import get_url, nowdate
from mrinimitable.utils.caching import redis_cache
from mrinimitable.website.router import get_doctypes_with_web_view, get_pages
...
def get_public_pages_from_doctypes():
	...
	if robots_txt := mrinimitable.get_single_value("Website Settings", "robots_txt"):
