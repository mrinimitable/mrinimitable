...
mrinimitable.ui.form.on("Email Group", {
			...
			frm.add_custom_button(
				...
				function () {
					mrinimitable.prompt(
						...
						function (data) {
							mrinimitable.call({
								method: "mrinimitable.email.doctype.email_group.email_group.import_from",
								args: {
									name: frm.doc.name,
			...
			frm.add_custom_button(
				...
				function () {
					mrinimitable.prompt(
						...
						function (data) {
							mrinimitable.call({
								method: "mrinimitable.email.doctype.email_group.email_group.add_subscribers",
								args: {
									name: frm.doc.name,
