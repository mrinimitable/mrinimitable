...
"""
	...
	def get_context(self, context):
		...
		if mrinimitable.form_dict.name:
			...
			context.has_delete_permission = mrinimitable.has_permission(
				self.doc_type, "delete", mrinimitable.form_dict.name
			)
	...
	def load_form_data(self, context):
		...
		if mrinimitable.form_dict.name:
			...
			context.title = (
				strip_html(
					mrinimitable.cstr(context.reference_doc.get(context.reference_doc.meta.get_title_field()))
				)
				or context.doc_name
			)
