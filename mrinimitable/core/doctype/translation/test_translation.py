...
class TestTranslation(IntegrationTestCase):
	def setUp(self):
		mrinimitable.db.delete("Translation")

	def tearDown(self):
		mrinimitable.local.lang = "en"
		from mrinimitable.translate import clear_cache
	...
	def test_doctype(self):
		...
		for lang, (source_string, new_translation) in translation_data.items():
			...
			mrinimitable.delete_doc("Translation", docname)
