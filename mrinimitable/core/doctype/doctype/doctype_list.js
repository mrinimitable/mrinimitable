mrinimitable.listview_settings["DocType"] = {
	...
	new_doctype_dialog(args) {
		...
		let non_developer = mrinimitable.session.user !== "Administrator" || !mrinimitable.boot.developer_mode;
		let fields = [
			{
				label: __("Name"),
				fieldname: "name",
		...
		let new_d = new mrinimitable.ui.Dialog({
			...
			primary_action(values) {
				...
				mrinimitable.db
					...
					.then((doc) => {
						mrinimitable.set_route("Form", "DocType", doc.name);
					});
			},
