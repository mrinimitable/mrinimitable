...
class TestDocumentNamingRule(IntegrationTestCase):
	...
	def test_naming_rule_by_condition(self):
		...
		# another rule
		naming_rule_1 = mrinimitable.copy_doc(naming_rule)
		...
		naming_rule_2 = mrinimitable.copy_doc(naming_rule)
		...
		todo = mrinimitable.get_doc(
			doctype="ToDo", priority="High", description="Is this my name " + mrinimitable.generate_hash()
		).insert()

		todo_1 = mrinimitable.get_doc(
			doctype="ToDo", priority="Medium", description="Is this my name " + mrinimitable.generate_hash()
		).insert()

		todo_2 = mrinimitable.get_doc(
			doctype="ToDo", priority="Low", description="Is this my name " + mrinimitable.generate_hash()
		).insert()
