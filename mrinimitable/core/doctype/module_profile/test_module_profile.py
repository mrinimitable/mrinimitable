...
class TestModuleProfile(IntegrationTestCase):
	def setUp(self):
		mrinimitable.delete_doc_if_exists("Module Profile", "_Test Module Profile", force=1)
		mrinimitable.delete_doc_if_exists("Module Profile", "_Test Module Profile 2", force=1)
		mrinimitable.delete_doc_if_exists("User", "test-module-user1@example.com", force=1)
		mrinimitable.delete_doc_if_exists("User", "test-module-user2@example.com", force=1)
	...
	def test_multiple_block_modules(self):
		...
		module_profile = mrinimitable.get_doc(
			{
				"doctype": "Module Profile",
				"module_profile_name": "_Test Module Profile",
