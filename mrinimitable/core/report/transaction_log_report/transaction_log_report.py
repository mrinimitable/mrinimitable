...
from mrinimitable.utils import format_datetime
...
def get_data(filters=None):
	result = []
	logs = mrinimitable.get_all("Transaction Log", fields=["*"], order_by="creation desc")

	for l in logs:
		row_index = int(l.row_index)
		if row_index > 1:
			previous_hash = mrinimitable.get_all(
				"Transaction Log",
