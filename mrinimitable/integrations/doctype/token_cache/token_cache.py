...
from mrinimitable.utils import cint, cstr, get_datetime, get_system_timezone
...
class TokenCache(Document):
	...
	def get_auth_header(self):
		...
		raise mrinimitable.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			mrinimitable.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
