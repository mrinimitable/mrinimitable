...
from mrinimitable.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/mrinimitable/mrinimitable/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(mrinimitable.db.exists(doctype, {"modified": ("<", threshold)}))
