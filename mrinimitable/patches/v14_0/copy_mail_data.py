...
def execute():
	...
	for email_account in mrinimitable.get_list("Email Account", filters={"enable_incoming": 1, "use_imap": 1}):
		# get all data from Email Account
		doc = mrinimitable.get_doc("Email Account", email_account.name)
