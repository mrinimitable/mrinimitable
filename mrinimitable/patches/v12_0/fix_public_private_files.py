...
def execute():
	files = mrinimitable.get_all("File", fields=["is_private", "file_url", "name"], filters={"is_folder": 0})
...
def generate_file(file_name):
	try:
		file_doc = mrinimitable.get_doc("File", file_name)
		# private
		new_doc = mrinimitable.new_doc("File")
