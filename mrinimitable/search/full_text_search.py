...
class FullTextSearch:
	"""Mrinimitable Wrapper for Whoosh"""
	...
	def create_index(self):
		mrinimitable.create_folder(self.index_path)
	...
	def search(self, text: str, scope: str | None = None, limit: int = 20) -> list[mrinimitable._dict]:
...
def get_index_path(index_name):
	return mrinimitable.get_site_path("indexes", index_name)
