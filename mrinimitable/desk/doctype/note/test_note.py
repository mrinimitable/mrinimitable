# Copyright (c) 2015, Mrinimitable Technologies Pvt. Ltd. and Contributors and Contributors
...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		mrinimitable.db.delete("Version")
		mrinimitable.db.delete("Note")
		mrinimitable.db.delete("Note Seen By")

		return mrinimitable.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = mrinimitable.get_doc("Version", dict(docname=note.name))
