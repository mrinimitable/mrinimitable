...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		mrinimitable.db.delete("Workspace", {"module": "Test Module"})
		mrinimitable.db.delete("DocType", {"module": "Test Module"})
		mrinimitable.delete_doc("Module Def", "Test Module")
	...
	# 	if mrinimitable.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = mrinimitable.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "mrinimitable"})
...
def create_workspace(**args):
	workspace = mrinimitable.new_doc("Workspace")
