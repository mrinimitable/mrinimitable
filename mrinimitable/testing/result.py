...
to provide custom formatting and logging for test results in the Mrinimitable framework.
...
test results during test execution in the Mrinimitable framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from mrinimitable.deprecation_dumpster import MrinimitableDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=MrinimitableDeprecationWarning)
...
class MrinimitableTestResult(unittest.TextTestResult):
	def __init__(self, stream, descriptions, verbosity):
		super().__init__(stream, descriptions, verbosity)
