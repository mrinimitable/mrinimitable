"""
This module contains the TestRunner class, which is responsible for executing test suites in Mrinimitable.
...
- Integration with Mrinimitable's configuration and environment setup
...
Usage:
The TestRunner is typically instantiated and used by Mrinimitable's test discovery and execution system.
...
class TestRunner(unittest.TextTestRunner):
	...
	def _prepare_category(self, category, suite, app):
		from mrinimitable.deprecation_dumpster import get_compat_mrinimitable_test_case_preparation

		dispatcher = {
			"integration": self.integration_preparation,
			"old-mrinimitable-test-class-category": get_compat_mrinimitable_test_case_preparation(self.cfg),
