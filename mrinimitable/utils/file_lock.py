...
Use `mrinimitable.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import mrinimitable
from mrinimitable.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in mrinimitable.local.locked_documents:
		doc.unlock()
