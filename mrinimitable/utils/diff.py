...
import mrinimitable
from mrinimitable.utils import pretty_date
...
def _get_value_from_version(version_name: int | str, fieldname: str):
	version = mrinimitable.get_list("Version", fields=["data", "modified"], filters={"name": version_name})
	if version:
