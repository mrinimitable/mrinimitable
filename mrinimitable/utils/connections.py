...
from mrinimitable import get_conf
from mrinimitable.exceptions import UrlSchemeNotSupported
...
def check_database():
	...
	if db_type == "sqlite":
		db_path = Path(mrinimitable.utils.get_site_path()) / "db" / f"{config.db_name}.db"
