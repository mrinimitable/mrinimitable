...
def get_excel_date_format():
	date_format = mrinimitable.get_system_settings("date_format")
	time_format = mrinimitable.get_system_settings("time_format")
...
def handle_html(data):
	...
	data = mrinimitable.as_unicode(data)
...
def read_xlsx_file_from_attached_file(file_url=None, fcontent=None, filepath=None):
	if file_url:
		_file = mrinimitable.get_doc("File", {"file_url": file_url})
