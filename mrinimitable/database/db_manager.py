...
class DbManager:
	def __init__(self, db: mrinimitable.database.database.Database | None = None):
		"""
	...
	def restore_database(verbose: bool, target: str, source: str, user: str, password: str) -> None:
		...
		from mrinimitable.utils import execute_in_shell
		...
		mrinimitable.cache.delete_keys("")  # Delete all keys associated with this site.
